...
- [SpEcHiDe/JsonBot](https://github.com/SpEcHiDe/JsonBot) - A JSON bot (updated with the latest BOT API features) with ability to send the JSON of most of the updates generated by Telegram BOT API.
